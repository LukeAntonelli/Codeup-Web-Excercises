...
var errorMessage = "Dave can't go that way dummy!"

var northAnswers = ['go north', 'north', 'norht', 'head north'];
...
while(currentLocation!=winDestination){
	switch(currentLocation){
		case "forest":
			...
			if(response.toLowerCase()=="go west"){
				currentLocation = "house";
				alert(errorMessage);
			}
			else if (response.toLowerCase()=="go south"){
		...
		case "clearing":
			...
			else if (response.toLowerCase()=="go north"){
		...
		case "pond":
			alert(pondMessage);
			response = prompt("Where would you like to go next?");
			if(response.toLowerCase()== "go north"){
				currentLocation = "house";
			}
			else if (response.toLowerCase() == "go east"){
				currentLocation = "clearing";
			}
		...
		case "house":
			alert(houseMessage);
			response = prompt("Where would you like to go next?");
			if(response.toLowerCase()=="enter the house"){
			...
			else if (response.toLowerCase()=="Go West"){
				currentLocation = "forest";
			}
			else{
				alert(errorMessage);
